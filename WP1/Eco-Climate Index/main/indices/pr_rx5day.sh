...
v=pr
vn=highest_five_day_precipitation_amount_per_time_period
idx=rx5day
...
set -e
CDO chname,$vn,$idx -selvar,$vn -eca_rx5day -runsum,5 $ftm $fou
ncatted -O -a long_name,$idx,m,c,"highest_five_day_precipitation_amount" $fou
ncatted -O -a standard_name,$idx,m,c,"Highest five day Precipitation Amount" $fou
ncatted -O -a units,$idx,m,c,"mm/5days" $fou
