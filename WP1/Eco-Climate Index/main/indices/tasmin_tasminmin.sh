#!/bin/bash
#SBATCH -J tas_tasminmin
#SBATCH -o logs/tas_tasminmin.o
#SBATCH -e logs/tas_tasminmin.e
#SBATCH -t 24:00:00
...
CDO chname,$v,$idx -timmin -selyear,$y1/$y2 $fin $fou
