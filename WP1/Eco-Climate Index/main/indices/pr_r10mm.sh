...
v=pr
vn=heavy_precipitation_days_index_per_time_period
idx=r10mm
...
set -e
CDO chname,$vn,$idx -divc,$dy -eca_r10mm $ftm $fou
ncatted -O -a long_name,$idx,m,c,"number_of_days_with_precipitation_sum_exceeding_10mm_per_year" $fou
ncatted -O -a standard_name,$idx,m,c,"Yearly Mean of Days with Precipitation exceeding 10mm" $fou
