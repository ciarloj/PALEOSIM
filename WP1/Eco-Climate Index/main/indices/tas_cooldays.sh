#!/bin/bash
#SBATCH -J tas_cooldays
#SBATCH -o logs/tas_cooldays.o
#SBATCH -e logs/tas_cooldays.e
#SBATCH -t 24:00:00
...
ncatted -O -a long_name,$idx,m,c,"yearly_number_of_cool_days" $fou
ncatted -O -a standard_name,$idx,m,c,"Yearly Number of days below 5-day 10p temperature" $fou
