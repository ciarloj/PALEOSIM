#!/bin/bash
#SBATCH -J tas_tasmaxmax 
#SBATCH -o logs/tas_tasmaxmax.o
#SBATCH -e logs/tas_tasmaxmax.e
#SBATCH -t 24:00:00
...
CDO chname,$v,$idx -timmax -selyear,$y1/$y2 $fin $fou
